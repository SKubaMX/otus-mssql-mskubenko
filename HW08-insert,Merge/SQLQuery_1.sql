...
*/
DECLARE @table TABLE(SupplierName VARCHAR(50))

DELETE TOP (1)
FROM Purchasing.Suppliers 
OUTPUT deleted.SupplierName 
Into @table (SupplierName)
...
SELECT SupplierName, PhoneNumber FROM Purchasing.Suppliers 
where SupplierName LIKE '%Contoso, Ltd. 1%' 
/*
...
exec master..xp_cmdshell 'bcp "[WideWorldImporters].Sales.InvoiceLines" out  "C:\Users\mskubenko\Desktop\otus-mssql-mskubenko\HW08\InvoiceLines1.txt" -T -w -t"@$$", -S ROCHWS1072\SQL2017'
